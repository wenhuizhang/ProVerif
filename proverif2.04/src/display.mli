...
val forget_trace_info : 'a Pitypes.reduc_state -> 'a Pitypes.reduc_state
...
sig
  ...
  val display_start_list : unit -> unit
  val display_end_list : unit -> unit
  ...
  val display_eq_indep : term * term -> unit
  ...
  val display_event : ?inj_idx_to_display:int list -> Pitypes.event -> unit
  ...
  val display_summary : (Pitypes.t_process_query * Pitypes.query_res) list -> Pitypes.grouped_axioms_t list -> Pitypes.grouped_axioms_t list -> Pitypes.grouped_lemmas_t list -> unit
